<div components="tag-manager add-remove-rows"
    ...
    <div component="sortable-list"
        ...
        <?php echo $__env->make('entities.tag-manager-list', ['tags' => $entity ? $entity->tags->all() : []], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>

    <button refs="add-remove-rows@add" type="button" class="text-button"><?php echo e(trans('entities.tags_add')); ?></button>
</div><?php /**PATH /var/www/bookstack/resources/views/entities/tag-manager.blade.php ENDPATH**/ ?>