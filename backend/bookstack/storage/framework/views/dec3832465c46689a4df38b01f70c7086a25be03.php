            ...
            <div class="p-l popup-content">
                ...
                <div class="form-group">
                    <div class="grid half no-break v-end mb-xs">
                        <div>
                            <label for="code-editor-content"><?php echo e(trans('components.code_content')); ?></label>
                        </div>
                        <div class="text-right">
                            <div component="dropdown" refs="code-editor@historyDropDown" class="inline block">
                                <button refs="dropdown@toggle" class="text-button text-small"><?php echo icon('history'); ?> <?php echo e(trans('components.code_session_history')); ?></button>
...
<?php /**PATH /var/www/bookstack/resources/views/pages/parts/code-editor.blade.php ENDPATH**/ ?>